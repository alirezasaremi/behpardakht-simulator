...
5. Goal 5: `bpVerifyRequest`. Complete: local SOAP table-2 adapter, bigint-safe complete Sale correlation, successful verification, documented already-verified result, and response audit. Goal 7 extends only reversed Verify result; timer work remains deferred. Goal 9 later adds separate scenario reachability.
