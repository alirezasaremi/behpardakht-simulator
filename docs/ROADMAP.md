...
6. Goal 6: `bpSettleRequest`. Complete: local SOAP table-3 adapter, bigint-safe verified-Sale correlation, accepted settlement-request record, source-backed `0`, no speculative nonzero code.
